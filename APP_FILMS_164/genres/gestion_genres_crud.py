...
def genre_update_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_update.submit.data:
            ...
            str_sql_update_intitulegenre = """UPDATE t_activity SET name_activity = %(value_name_genre)s WHERE activity_id = %(value_id_genre)s """
            with DBconnection() as mconn_bd:
...
def genre_delete_wtf():
    ...
    try:
        ...
        if request.method == "GET":
            ...
            str_sql_genres_films_delete = """SELECT activity_weather_id, name_weather, activity_id, name_activity, score FROM t_activity_weather 
