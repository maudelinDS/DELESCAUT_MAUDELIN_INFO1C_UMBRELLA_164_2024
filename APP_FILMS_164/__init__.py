...
try:
    ...
    from APP_FILMS_164.activity_season import gestion_activity_season_crud
    from APP_FILMS_164.activity_environnement import gestion_activity_environ_crud
    from APP_FILMS_164.activity_temperature import gestion_activity_temp_crud
    ...
    from APP_FILMS_164.meteo import gestion_meteo_crud
    from APP_FILMS_164.meteo import gestion_meteo_wtf_forms

    from APP_FILMS_164.environement import gestion_environ_crud
    from APP_FILMS_164.environement import gestion_environ_wtf_forms

    from APP_FILMS_164.season import gestion_season_crud
    from APP_FILMS_164.season import gestion_season_wtf_forms

    from APP_FILMS_164.temperature import gestion_temp_crud
    from APP_FILMS_164.temperature import gestion_temp_wtf_forms
