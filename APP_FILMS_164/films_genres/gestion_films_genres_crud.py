    ...
    if request.method == "GET":
        try:
            with DBconnection() as mc_afficher:
                strsql_genres_films_afficher_data = """SELECT name_weather,name_activity,score,
            GROUP_CONCAT(DISTINCT activity_weather_id ORDER BY activity_weather_id) as ActivityWeatherIDs,
            GROUP_CONCAT(DISTINCT name_activity ORDER BY name_activity) as ActivityWeather
            ...
            GROUP BY 
            name_weather,name_activity,score;"""
                if id_film_sel == 0:
...
def update_genre_film_selected():
    if request.method == "POST":
        try:
            ...
            # "fk_weather"/"weather_id" et "fk_activity"/"activity_id" dans la "t_activity_weather"
